...
/*:fr
 * @target MZ
 * @plugindesc (V2.0.0) Permet d'avoir une durabilitée sur les armes et armures
 * @author Rotomeca
...
(() => {
    ...
    // ** Alias
    //=============================================================================
    //const $createUniqueItem   = Rotomeca.RotomecaUniqueItems.$createUniqueItem;
    const $createUniqueWeapon = Rotomeca.RotomecaUniqueItems.$createUniqueWeapon;
    const $createUniqueArmor  = Rotomeca.RotomecaUniqueItems.$createUniqueArmor;
    const Game_ItemUnique     = Rotomeca.RotomecaUniqueItems.Game_ItemUnique;
    const UniqueItem          = Rotomeca.RotomecaUniqueItems.UniqueItem;
    ...
    Rotomeca.RotomecaItemDurability.BrokenReward = BrokenReward;
