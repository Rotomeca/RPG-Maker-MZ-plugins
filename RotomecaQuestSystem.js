 ...
 * @type {QuestDatabase}
 */
var $gameQuests = $gameQuests || null;
...
(() => {
    ...
    * =============================================================================*/
    ...
    Rotomeca.RotomecaQuestSystem.$questExist = $questExist;
    Rotomeca.RotomecaQuestSystem.$questHave = $questHave;
    Rotomeca.RotomecaQuestSystem.$questValidate = $questValidate;
    Rotomeca.RotomecaQuestSystem.$questFailed = $questFailed;
    Rotomeca.RotomecaQuestSystem.$questInProgress = $questInProgress;
    Rotomeca.RotomecaQuestSystem.$questIsAdded = $questIsAdded;
    Rotomeca.RotomecaQuestSystem.RotomecaQuestSteps = RotomecaQuestSteps;
    Rotomeca.RotomecaQuestSystem.RotomecaQuestReward = RotomecaQuestReward;
    Rotomeca.RotomecaQuestSystem.RotomecaQuest = RotomecaQuest;
    Rotomeca.RotomecaQuestSystem.QuestDatabase = QuestDatabase;
    Rotomeca.RotomecaQuestSystem.QuestBook = QuestBook;
    Rotomeca.RotomecaQuestSystem.Window_MenuQuestCommand = Window_MenuQuestCommand;
    Rotomeca.RotomecaQuestSystem.Window_QuestSelect = Window_QuestSelect;
    Rotomeca.RotomecaQuestSystem.Window_QuestBase = Window_QuestBase;
    Rotomeca.RotomecaQuestSystem.Window_QuestMain = Window_QuestMain;
    Rotomeca.RotomecaQuestSystem.Window_QuestDesc = Window_QuestDesc;
    Rotomeca.RotomecaQuestSystem.Window_QuestSteps = Window_QuestSteps;
    Rotomeca.RotomecaQuestSystem.Window_QuestRewards = Window_QuestRewards;
    Rotomeca.RotomecaQuestSystem.Window_Quest = Window_Quest;
    Rotomeca.RotomecaQuestSystem.Scene_Quest = Scene_Quest;
})();